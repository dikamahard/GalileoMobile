...
public class CallCenterTest {
    ...
    public void callCenterTest() throws InterruptedException {
        ...
        String expectedTitle = "Help Center Galileo";
        ...
        driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollable(true)).scrollIntoView(new UiSelector().description(\"Call Center\"))")).click();
        ...
        new WebDriverWait(driver, Duration.ofSeconds(5)).until(ExpectedConditions.visibilityOfElementLocated(callCenterPage.composeTo));

        assertEquals(expectedTitle, callCenterPage.getEmailTitle().getAttribute("text"));
    }
}
